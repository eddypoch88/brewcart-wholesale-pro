  ...
  return (
    <div className="min-h-full pb-28 pt-12 px-6">
      ...
      <div className="flex flex-col items-center mb-10 animate-in fade-in zoom-in duration-300">
        ...
        <h2 className="text-xl font-semibold text-slate-800 dark:text-white tracking-tight">Store Owner</h2>
        <div className="mt-3 flex items-center gap-2">
          <span className="text-primary font-semibold text-xs uppercase tracking-wide bg-primary/10 px-3 py-1 rounded-full border border-primary/20">Admin</span>
      ...
      <div className="space-y-4 mb-8">
        <h3 className="text-xs font-semibold text-slate-500 dark:text-slate-500 uppercase tracking-wide pl-2 mb-2">Store Management</h3>

        {/* Product/Items -> Blue */}
        <MenuCard icon="store" title="Shop Settings" subtitle="Display, menus, hours" variant="product" />
        <MenuCard icon="inventory_2" title="Inventory Preferences" subtitle="Stock alerts, supplier lists" variant="product" />
      ...
      <p className="text-center text-xs text-slate-300 dark:text-slate-600 mt-6 font-medium">v3.1.0 (Build 902)</p>
    </div>
  );
};
